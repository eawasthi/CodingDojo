...
class UserManager(models.Manager):
	def validateUser(self, postData):
		...
		if validation_errors:
			...
			user=self.create(firstname= postData['firstname'], lastname= postData['lastname'],email= postData['email'])
...
class Users(models.Model):
	...
	confirmpass = models.CharField(max_length = 45)
...
class Books(models.Model):
	...
	created_at = models.DateTimeField(auto_now_add = True)
	updated_at = models.DateTimeField(auto_now = True)
	fUsers = models.ForeignKey(Users,blank=True, null=True)
